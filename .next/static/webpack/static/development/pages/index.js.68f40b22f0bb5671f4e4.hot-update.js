    ...
    value: function render() {
      ...
      if (this.state.currency === 'USD') {
        list = __jsx("li", {
          ...
          __self: this
        }, "\xA0", this.props.bpi.USD.code), __jsx("strong", {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 14
          },
          __self: this
        }, "\xA0", this.props.bpi.USD.rate));
        ...
        list = __jsx("li", {
          ...
          __self: this
        }, "\xA0", this.props.bpi.GBP.code), __jsx("strong", {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 21
          },
          __self: this
        }, "\xA0", this.props.bpi.GBP.rate));
        ...
        list = __jsx("li", {
          ...
          __self: this
        }, "\xA0", this.props.bpi.EUR.code), __jsx("strong", {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 28
          },
          __self: this
        }, "\xA0", this.props.bpi.EUR.rate));
      }
...
//# sourceMappingURL=index.js.68f40b22f0bb5671f4e4.hot-update.js.map